...
void CollisionSphere::collide(CollisionBox& box) { boxSphereCollisionImpl(box, *this, collData); }

void CollisionSphere::collide(CollisionSphere& sphere) { sphereSphereCollisionImpl(sphere, *this, collData); }

void CollisionSphere::collide(CollisionPlane& plane) { spherePlaneCollisionImpl(*this, plane, collData); }

void CollisionBox::collide(CollisionBox& box) { boxBoxCollisionImpl(box, *this, collData); }

void CollisionBox::collide(CollisionSphere& sphere) { boxSphereCollisionImpl(*this, sphere, collData); }

void CollisionBox::collide(CollisionPlane& plane) { boxPlaneCollisionImpl(*this, plane, collData); }

void CollisionPlane::collide(CollisionBox& box) { boxPlaneCollisionImpl(box, *this, collData); }

void CollisionPlane::collide(CollisionSphere& sphere) { spherePlaneCollisionImpl(sphere, *this, collData); }
