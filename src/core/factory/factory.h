...
{
    template<typename... Args> static entt::entity create(Args&& ...args);
    ...
    static entt::entity createCapsule(const Vector3& pos, const Vector3& velocity, const float radius, const float height, const float mass);
};
