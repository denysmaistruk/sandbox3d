...
struct EntityFactory
{
    ...
    static entt::entity createLight(Shader shader, int type, Vector3 position, Vector3 target, Color color, float cutoff = 0.7f, float lightRadius = 10.f, float spotSoftness = 0.65f);
};